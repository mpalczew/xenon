...
impl XenonApp {
    ...
    pub(super) fn run_command(
        ...
        match id {
            ...
            CommandId::GoToDefinition => self.go_to_definition(cx),
            CommandId::NextDiagnostic => self.next_diagnostic(true, cx),
            CommandId::PreviousDiagnostic => self.next_diagnostic(false, cx),
