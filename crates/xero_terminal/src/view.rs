...
use anyhow::Result;
use gpui::{
    App, AppContext, Bounds, ClipboardEntry, ClipboardItem, Context, ElementInputHandler, Entity,
    EntityInputHandler, EventEmitter, FocusHandle, Focusable, Image, ImageFormat,
    InteractiveElement, IntoElement, KeyDownEvent, MouseButton, MouseDownEvent, MouseMoveEvent,
    MouseUpEvent, ParentElement, Pixels, Point, Render, ScrollWheelEvent,
...
fn terminal_clipboard_text(item: ClipboardItem) -> Option<String> {
